---
title: "Solver Integration Skill"
description: "AI-optimized reference for building solvers and market makers that provide liquidity to the Nima RFQ Protocol"
---

<Info>
**Install as a Claude Code Skill**

Add this reference directly to your Claude Code setup so Claude can use it when building your solver:

```bash
# Project-level (recommended — shared with your team)
mkdir -p .claude/skills/solver-integration-nima-rfq && curl -sL https://raw.githubusercontent.com/Miljan9602/docs/main/skills/solver-integration-SKILL.md -o .claude/skills/solver-integration-nima-rfq/SKILL.md

# User-level (available in all your projects)
mkdir -p ~/.claude/skills/solver-integration-nima-rfq && curl -sL https://raw.githubusercontent.com/Miljan9602/docs/main/skills/solver-integration-SKILL.md -o ~/.claude/skills/solver-integration-nima-rfq/SKILL.md
```

After installing, Claude will automatically discover and use this skill when you ask it to build a solver for the Nima RFQ Protocol.
</Info>
