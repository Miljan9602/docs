...
RFQ Protocol enables **gasless, atomic token swaps** by sourcing fixed quotes from professional solvers—delivering better pricing, zero slippage, and MEV protection.

## What is RFQ?

RFQ (Request for Quote) is a trading model where users request fixed prices from professional solvers and execute the trade only after explicitly accepting the quote. It enables better pricing, zero slippage, and MEV protection, especially for large or illiquid trades.
