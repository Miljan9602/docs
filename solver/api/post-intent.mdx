...
<ParamField body="taker_data" type="object" required>
  ...
  <Expandable title="taker_data object (HTTP nested structure)">
    <ParamField body="swap_intent" type="object" required>
      The taker's original swap intent (amounts as signed by the user)
      <Expandable title="swap_intent fields">
        <ParamField body="inputToken" type="string" required>Token user is selling</ParamField>
        <ParamField body="outputToken" type="string" required>Token user is buying</ParamField>
        <ParamField body="inputAmount" type="string" required>Original input amount in wei (as signed by the user)</ParamField>
    ...
    <ParamField body="signature_params" type="object" required>
      ...
      <Expandable title="signature_params fields">
        <ParamField body="deadline" type="string" required>Signature expiry Unix timestamp (seconds)</ParamField>
