...
The `frontendReferral` field is **bytes32**, not an address. Use:

```
frontendReferral = toHex('your-frontend-id', { size: 32 })
```

Contact the RFQ Protocol team to register your referral identifier.
