...
<ResponseField name="markets" type="array">
  ...
  <Expandable title="Market object">
    ...
    <ResponseField name="min_size" type="number | null">
      Minimum trade size in input token units. `null` means no minimum.
    </ResponseField>
    <ResponseField name="max_size" type="number | null">
      Maximum trade size in input token units. Dynamically derived from solver on-chain balances. `null` means no maximum.
    </ResponseField>
  </Expandable>
</ResponseField>
